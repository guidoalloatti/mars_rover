...
The solution is on Javascript and jQuery, directly applied to the application.js in the assets.

To use the UI, just start rails with:
  rails s
and go to the root directory.

To run the tests under jasmine, just run:
